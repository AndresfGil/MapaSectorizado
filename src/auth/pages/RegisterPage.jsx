...
const formValidations = {
  ...
  photoURL: [
    ...
    "Debe agregar una foto desde un URL valido.",
  ],
};
...
export const RegisterPage = () => {
  ...
  const {
    formState, displayName, email, password, lastname, age, photoURL, onInputChange, isFormValid,
    displayNameValid, emailValid, passwordValid, lastnameValid, ageValid, photoURLValid,
